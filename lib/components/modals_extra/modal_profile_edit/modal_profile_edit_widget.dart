              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'zkuj82f1' /* Below are your profile details */,
                      ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'oz16aiv0' /* The email associated with this... */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '4bhhduhm' /* casper@ghostbusters.com */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge,
                                    )),

              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'izyo9b43' /* Create Company Profile */,
                      ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '686mkioq' /* Upload images about your compa... */,
                      ),
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'h4ajkt58' /* Enter in your website without ... */,
                              ),
                              hintStyle:
                                  FlutterFlowTheme.of(context).labelMedium,
                              enabledBorder: OutlineInputBorder(

                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'jpd495j6' /* Contracts for New Opportunitie... */,
                                ),
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '09in7woa' /* "Notifications and reminders i... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                                              ...
                                              children: [
                                                ...
                                                TextSpan(
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '81wuqq7a' /* sent a SOW Change Order for  */,
                                                  ),
                                                  style: TextStyle(),
                                                ),
                                                TextSpan(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'imvslws0' /* "Please review the updates to ... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'dzua53hy' /* Updates to Existing App */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall,
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'vxynsf23' /* Additional Details around this... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'zndvivhq' /* The user can browse through ou... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ),

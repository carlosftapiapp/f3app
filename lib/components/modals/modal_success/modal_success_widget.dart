                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'xlz1uec0' /* Send Contract Confirmation */,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'o64vbem8' /* A new contract has been genera... */,
                            ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '384iqeso' /* Send the information below. An... */,
                            ),
                            style: FlutterFlowTheme.of(context).labelMedium,
                          ).animateOnPageLoad(

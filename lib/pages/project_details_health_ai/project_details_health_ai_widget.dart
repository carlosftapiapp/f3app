                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'rot0vgbj' /* Client Acquisition for Q3 */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ).animateOnPageLoad(animationsMap[
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'b81xwc5d' /* Additional Details around this... */,
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'ogzrjewu' /* Additional Details around this... */,
                                ),
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ),
                            ),

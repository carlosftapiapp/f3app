                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                      ...
                                      'dk0r753h' /* celular number */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'n6wn25da' /* Enter your celular number here... */,
                                    ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'ptkdzjwh' /* Email Address */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '1odq62cu' /* Enter your email here... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    enabledBorder: OutlineInputBorder(
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'z7c7p4qg' /* Confirm Password */,
                                ),
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: FFLocalizations.of(context).getText(
                                  '2nzkl3hm' /* Create your password... */,
                                ),
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: OutlineInputBorder(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '5gjin1j7' /* Already have an account? */,
                                ),

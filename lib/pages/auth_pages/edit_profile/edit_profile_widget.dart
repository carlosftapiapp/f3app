...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.nombrefarmaciaController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.nombrefarmacia, ''));
    _model.nombrefarmaciaFocusNode ??= FocusNode();
    ...
    _model.provinciaController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.provincia, ''));
    ...
    _model.rucController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.rucfarmacia, 0).toString());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => TextFormField(
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        cursorColor: FlutterFlowTheme.of(context).primary,
                        validator: _model.cedulaControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => TextFormField(
                        controller: _model.nombrefarmaciaController,
                        focusNode: _model.nombrefarmaciaFocusNode,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            'jrjwcarg' /* Your Name farmacia */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).labelMedium,
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        cursorColor: FlutterFlowTheme.of(context).primary,
                        validator: _model.nombrefarmaciaControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => TextFormField(
                        controller: _model.provinciaController,
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        cursorColor: FlutterFlowTheme.of(context).primary,
                        validator: _model.provinciaControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => TextFormField(
                        controller: _model.rucController,
                        focusNode: _model.rucFocusNode,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '275fcsgy' /* RUC  PHARMACYS */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).labelMedium,
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primary,
                        validator:
                            _model.rucControllerValidator.asValidator(context),
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: SelectionArea(
                        child: Text(
                      FFLocalizations.of(context).getText(
                        'fw75kazd' /* The email associated with this... */,
                      ),
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 4.0, 0.0, 24.0),
                    child: SelectionArea(
                        child: Text(
                      currentUserEmail,
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await currentUserReference!
                          ...
                          apellido: _model.apellidoController.text,
                          cedula: int.tryParse(_model.cedulaController.text),
                          nombrefarmacia: _model.nombrefarmaciaController.text,
                          direccion: _model.direccionController.text,
                          provincia: _model.provinciaController.text,
                          ciudad: _model.ciudadController.text,
                          rucfarmacia: int.tryParse(_model.rucController.text),
                        ));
                        context.pop();

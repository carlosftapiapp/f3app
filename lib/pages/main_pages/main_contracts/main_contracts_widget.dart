                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '7alvkzso' /* No-Code Platform Design */,
                                                    ),
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '4szywyrj' /* Contracts for New Opportunitie... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'kzfsyaal' /* Client Acquisition for Q3 */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium,
